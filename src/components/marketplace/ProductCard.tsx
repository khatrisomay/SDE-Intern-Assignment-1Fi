...
export const ProductCard: React.FC<ProductCardProps> = ({ product, onSelect }) => {
  ...
  return (
    <div
      ...
      className="group relative flex flex-col rounded-[22px] border border-zinc-200/90 bg-white p-3.5 shadow-[0_2px_10px_rgba(20,14,50,0.04)] hover:shadow-[0_8px_24px_rgba(113,44,220,0.12)] hover:border-[#712CDC]/40 transition-all duration-300 cursor-pointer overflow-hidden"
    >
      {/* Top badges bar */}
      ...
      <div className="flex gap-3.5 items-center">
        {/* Product Image */}
        <div className="relative h-24 w-24 shrink-0 rounded-2xl bg-[#f8f6fc] p-2 flex items-center justify-center overflow-hidden border border-purple-50">
          <img
