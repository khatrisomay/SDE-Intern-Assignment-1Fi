      ...
      <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-gray-100 px-3.5 py-2.5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              className="relative p-1.5 rounded-full text-gray-600 hover:bg-gray-100"
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-gray-100 px-6 lg:px-10 py-4 shadow-xs">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        {/* Desktop Right Controls: Credit Limit & Simulator Toggle */}
        <div className="flex items-center gap-4">
          <div className="flex flex-col text-right">
            <span className="text-xs text-gray-500 font-medium">Available Credit Limit</span>
          ...
          <button
            type="button"
            className="relative p-2.5 rounded-xl text-gray-600 hover:bg-gray-100 transition-colors border border-gray-100"
            aria-label="Notifications"
          >
            <Bell className="w-5 h-5 text-gray-700" />
            <span className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#712CDC]" />
          </button>
        </div>
      </div>
    </header>
